        ...
        for index in range(1, pagesize+1):
            ...
            try:
                try:
                    try:
                        try:
                            answer = driver.find_element(By.XPATH, f"/html/body/div[{position}]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/div[2]/div[1]").text
                        except Exception as e:
                            answer = driver.find_element(By.XPATH, f"/html/body/div[{position}]/div[3]/div/div[1]/div[3]/div[3]/div[2]/div/div[2]/div[1]").text
                    except Exception as e:
                        answer = driver.find_element(By.XPATH, f"/html/body/div[{position}]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/div[2]/div[2]").text
                except Exception as e:
                    answer = driver.find_element(By.XPATH, f"/html/body/div[{position}]/div[3]/div/div[1]/div[3]/div[3]/div[2]/div/div[2]/div[2]").text
            except Exception as e:
                continue
            if len(answer) < 1:
                continue
